...
cust_data = read.csv(file = , header = TRUE,na.strings = "NA")
View(cust_data)
names(cust_data)
str(cust_data)
...
cust_data$NumberOfTime30.59DaysPastDueNotWorse[cust_data$NumberOfTime30.59DaysPastDueNotWorse>12.9993772]<- 13
cust_data$DebtRatio[cust_data$DebtRatio>6466.4650758]<- 6466.4650758
cust_data$NumberOfOpenCreditLinesAndLoans[cust_data$NumberOfOpenCreditLinesAndLoans>23.890613]<- 24
cust_data$NumberOfTimes90DaysLate[cust_data$NumberOfTimes90DaysLate>12.7738847]<- 13
cust_data$NumberRealEstateLoansOrLines[cust_data$NumberRealEstateLoansOrLines>4.407553]<- 4
cust_data$NumberOfTime60.89DaysPastDueNotWorse[cust_data$NumberOfTime60.89DaysPastDueNotWorse>12.7059249]<- 13
...
m5 <- glm(SeriousDlqin2yrs ~ 
            ...
            #NumberOfOpenCreditLinesAndLoans+
            NumberRealEstateLoansOrLines+
            NumberOfDependents, data = testing, 
          family = binomial(logit))
summary(m5)
